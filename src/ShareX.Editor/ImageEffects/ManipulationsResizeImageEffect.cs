...
public class ManipulationsResizeImageEffect : ImageEffect
{
    ...
    public ManipulationsResizeImageEffect(int width, int height, bool maintainAspectRatio = false)
    {
        _width = width;
        _height = height;
    ...
    public ManipulationsResizeImageEffect()
    {
        _name = "Resize image";
    }
