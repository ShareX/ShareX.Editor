...
public class ManipulationsAutoCropImageEffect : ImageEffect
{
    ...
    public ManipulationsAutoCropImageEffect(SKColor color, int tolerance = 0)
    {
        _color = color;
        _tolerance = tolerance;
    }

    public ManipulationsAutoCropImageEffect()
    {
    }
