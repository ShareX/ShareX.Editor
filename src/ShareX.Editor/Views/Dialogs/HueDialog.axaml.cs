...
namespace ShareX.Editor.Views.Dialogs
{
    public partial class HueDialog : UserControl, IEffectDialog
    {
        ...
        private void RequestPreview()
        {
             ...
             var effect = new HueImageEffect { Amount = amount };
             PreviewRequested?.Invoke(this, new EffectEventArgs(img => effect.Apply(img), $"Hue: {amount:0}°"));
        }
        ...
        private void OnApplyClick(object? sender, RoutedEventArgs e)
        {
            ...
            var effect = new HueImageEffect { Amount = amount };
            ApplyRequested?.Invoke(this, new EffectEventArgs(img => effect.Apply(img), $"Adjusted hue by {amount:0}°", effect));
        }
